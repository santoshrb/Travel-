  ...
  def booking_communication_detail
    @booking_communications = BookingCommunication.all
      respond_to do |f|
        ...
        f.html
        f.pdf do
          render pdf: ' booking_communication_detail',
          layout: 'pdf.html',
          orientation: 'Landscape',
          template: 'booking_communications/booking_communication_detail.pdf.erb',
